...
You can hear some samples generated by the model in various stages of training / development [here](https://drive.google.com/drive/folders/1aCs0HWvocO1-EN2dXhEa3Hwcje1xeO24?usp=drive_link). 
...
* In December/2023 I began training variational auto-encoder models to try a latent diffusion model.
   ...
   * I found that although it was possible for a VAE that includes phase to have good reconstruction quality and a compact latent space, the latent space had high entropy and was not easily interpretable by the latent diffusion model.
